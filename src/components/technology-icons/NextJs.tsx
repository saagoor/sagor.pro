...
export default function NextJs(props: JSX.IntrinsicAttributes & SVGProps<SVGSVGElement>) {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" {...props} viewBox="0 0 207 124">
            <g fill="none" fillRule="evenodd" stroke="none" strokeWidth="1">
                <g fill="#fff" fillRule="nonzero" transform="translate(-247 -138)">
