...
export default function ListLayout({ posts, title, description = '', initialDisplayPosts = [], pagination }) {
    ...
    <>
      <div className="divide-y divide-gray-200 dark:divide-gray-700">
        <div className="pt-6 pb-8 space-y-2 md:space-y-5">
          ...
          {description && (<p className="text-lg leading-7 text-gray-500 dark:text-gray-400">{description}</p>)}
